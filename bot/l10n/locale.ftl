...
strategy-result =
    ...
    ━━━━━━━━━━━━━━━━━━━━━━
    { $payback ->
        [one] Окупаемость 1 аккаунта - <b>{$payback} неделю </b>💰
        [few] Окупаемость 1 аккаунта - <b>{$payback} недели</b>💰
        [many] Окупаемость 1 аккаунта - <b>{$payback} недель</b>💰
        *[other] Окупаемость 1 аккаунта - <b>{$payback} недель</b>💰
    }
    ━━━━━━━━━━━━━━━━━━━━━━
...
general-accounts-info =
    ...
    👤  Всего аккаунтов: <b>{$accounts}</b>
                    ...
                    🏷Cтатистика банов🏷
    ━━━━━━━━━━━━━━━━━━━━━
    ⛔️  Всего забанено: <b>{$total_bans}</b>
    ...
    📆  Банов за последние 7 дней: <b>{$bans_in_last_week}</b>
                ...
                🏷Cтатистика инвентарей🏷
    ━━━━━━━━━━━━━━━━━━━━━
    Всего предметов: <b>{$items}</b>
    Всего кейсов: <b>{$cases}</b>
    Общая цена: <b>{$prices} рублей</b>
    </blockquote>
...
error-accounts-dump = 
    ❗️<b>Ошибка!</b> У вас нет аккаунтов❗️
...
admin-info = 
    Админ панель:
    Всего пользователей бота - {$members}
    всего товаров в бд - 52 (писят два)
    ПИСЬКИ в колличестве - 500