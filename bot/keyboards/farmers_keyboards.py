...
def get_strategy_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="Назад↩️", callback_data="back_farmers"),
            ]
        ]
    )
...
def get_cancel_strategy_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text='Назад↩️', callback_data="back_strategy")
            ]
        ]
    )
...
def get_personal_inventory_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text='Назад↩️', callback_data="back_inventory")
            ]
        ]
    )
...
def get_personal_inventory_settings_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text='Назад↩️', callback_data="back_personal_inventory")
            ]
        ]
    )
